...
try:
    ...
    print("Please install flask-socketio and python-socketio:")
    print("pip install flask-socketio python-socketio")
...
# Initialize the Gemini model only if LangChain is available
